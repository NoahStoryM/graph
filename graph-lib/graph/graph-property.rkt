...
(define-syntax-rule (define-edge-properties g p ...)
  (begin (define-edge-property g p) ...))

#;(define-syntax-rule (define-graph-properties g p ...)
    (begin (define-graph-property g p) ...))
